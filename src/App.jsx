...
const ProtectedRoute = ({ children, allowedTypes = [] }) => {
  const { token, loginType } = useSelector(state => state.auth);
  ...
  if (allowedTypes.length && !allowedTypes.includes(loginType)) {
    let redirectTo = '/';
    if (loginType === 'USER') redirectTo = '/dashboard/account-setting';
    else if (loginType === 'BUSINESS') redirectTo = '/business-owner/dashboard/account-setting';
    else if (loginType === 'INDEPENDENT') redirectTo = '/independent/dashboard/account-setting';
        ...
        <Router>
          <Suspense fallback={<LoadingFallback />}>
            ...
            <Routes>
              ...
              <Route element={<ProtectedRoute allowedTypes={['BUSINESS']} />}>
              ...
              <Route element={<ProtectedRoute allowedTypes={['INDEPENDENT']} />}>
