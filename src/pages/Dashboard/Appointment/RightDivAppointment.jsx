    ...
    const renderCalendar = (events, highlightColor) => {
        ...
        for (let i = 0; i < totalCells; i++) {
            ...
            days.push(
                <div
                    key={i}
                    className={`flex items-center justify-center h-8 text-sm font-medium ${isValidDay ? 'text-white' : ''
                        } ${isHighlighted ? `bg-[${highlightColor}] rounded-full` : ''}`}
                >
            ...
            <div className="">
                ...
                <div className="bg-[#2F3333] rounded-b-2xl  p-4">
                    ...
                    <div className="space-y-3">
                        <button className="w-full bg-[#FFE6D8] text-[#FF5534] py-3 rounded-lg font-medium text-sm hover:bg-[#FFB89A] transition-colors">
                            Import Bookings
                        </button>
                        <button className="w-full bg-[#FFE6D8] text-[#FF5534] py-3 rounded-lg font-medium text-sm hover:bg-[#FFB89A] transition-colors">
                            Connect A Calendar
