...
const RightSalonDetails = ({ salon }) => {
  const navigate = useNavigate();
  const [isOpen, setIsOpen] = useState(false);
  const [selectedLocation, setSelectedLocation] = useState(salon?.address || "Plano, TX 75093");

  const locations = [
    salon?.address || "Plano, TX 75093",
    "Plano, TX 75094",
    "New York, NY 10011",
    "New York, NY 10012",
  ];
    ...
    <>
      <div className="space-y-3">
        ...
        <div className="">
          ...
          <p className="font-rasa font-[400] sm:text-[16px] text-[12px] text-[#2F2F2F]">{salon?.fullName || 'Omar Vaccaro'}</p>
        ...
        <div className=''>
          ...
          <p className="font-rasa font-[400] sm:text-[16px] text-[10px] text-[#2F2F2F] leading-relaxed">
            {salon?.description || 'I am a well-rounded Hairstylist, meaning no matter what type of hair you have I can do it well! I am also a Cosmetology Teacher which means I have made it my business to perfect my craft, to be able to provide top quality service to my clientele.'}
          </p>
        </div>
        ...
        <div className="">
          ...
          <p className="font-rasa font-[400] sm:text-[16px] text-[10px] text-[#2F2F2F] leading-relaxed">
            You will not be charged if you cancel at least 24 hours before your appointment starts. Otherwise, you will be charged 50% of service price for canceling with less than 24 hours notice and 100% if you fail to show up at your appointment.
          </p>
        </div>
      </div>
    </>
