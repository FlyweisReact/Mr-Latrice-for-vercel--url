...
export const WaiverFormModal = ({ isOpen, onClose, formData }) => {
  const [signatureName, setSignatureName] = useState(formData?.waiverFormAnswers?.signature || "");
  const [consent, setConsent] = useState(formData?.waiverFormAnswers?.consent || "");
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Submitted Waiver Form:", answers);
          ...
          <div className="mb-5">
            <div className="border border-[#2F2F2F] rounded-[10px] p-4">
              ...
              <div className="mt-6">
                ...
                <div className="mt-2">
                  <select
                    className="border border-[#2F2F2F] p-2 rounded-[6px] w-full"
                    value={consent}
              ...
              <div className="mt-6">
                ...
                <div className="mt-2">
                  ...
                  >
                    ...
                    {signatureName || "Click here to upload signature"}
                    <input
                      id="signature-upload"
                      type="file"
                      accept="image/*"
